 ...
 */
@Internal
class QueryableCollection<T> implements Queryable<T>, Iterable<T>, Serializable {
     ...
     */
    public <K> Queryable<Tuple2<K, Queryable<T>>> groupby(Function<? super T, ? extends K> classifier) {
